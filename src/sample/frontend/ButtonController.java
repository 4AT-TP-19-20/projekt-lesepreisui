...
import sample.frontend.controls.SaveAlert;
import sample.utils.Callable;
...
public class ButtonController {
    ...
    public static void addCloseRequestHandler() {
    ...
    public static void enableSaveDiscardSystem(Saveable saveable) {
