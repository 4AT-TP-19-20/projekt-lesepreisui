...
import sample.frontend.CustomResizePolicy;

import java.util.Optional;
import java.util.stream.Stream;

public class CustomTableView<S extends Searchable & Comparable<S>> extends TableView<S> {
    ...
    public <T> void addColumn(String title, Callback<TableColumn.CellDataFeatures<S, T>, ObservableValue<T>> factory) {
